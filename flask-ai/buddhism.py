...
# ✅ Paths
DATA_PATH = "faiss_index_buddhism"
TEXT_PATH = "Buddhism.txt"
...
def get_gemini_response(question, context):
    ...
    prompt = f"Context: {context}\n\nQuestion: {question}\n\nAnswer in 7-8 lines as a wise Buddhist monk.And give it in easy sentences and follow grammatical rules"
...
def home():
    ...
    <body>
        <video autoplay loop class="background-video" id="bgVideo">
            <source src="static/videos/buddhism_background.mp4" type="video/mp4">
        </video>
        <div class="container">
            <div class="glass-box">
                <h1>Ask Buddhism AI</h1>
                <form action="/get_response_buddhism" method="POST">
...
@app.route('/get_response_buddhism', methods=['POST'])
def get_response_buddhism():
    ...
    <html>
    <head>
        <title>Your Buddhist Wisdom</title>
        <style>
            body {{
                font-family: Arial, sans-serif;
                background: black;
    ...
    <body onload="showResponseText()">
        <div class="response-container">
            <h1>Your Buddhist Wisdom</h1>
            <p id="responseText"></p>
            <a href="/">Try Again</a>
        </div>
        <div class="video-container">
            <video autoplay loop muted playsinline class="background-video" id="bgVideo">
                <source src="{{ url_for('static', filename='videos/buddhism_background.mp4') }}" type="video/mp4">
            </video>
        </div>
    </body>
    </html>
