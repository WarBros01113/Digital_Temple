  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "http://127.0.0.1:5001/get_response_christianity", // ✅ Flask API for Christianity
        { question },
  ...
  return (
    ...
    >
      ...
      <video autoPlay loop muted className="background-video">
        <source
          src="http://127.0.0.1:5003/static/videos/background.mp4" // ✅ Use a Christian-themed video
          type="video/mp4"
        />
        Your browser does not support the video tag.
      </video>

      <h1>Ask Christian AI ✝️</h1>
      <form onSubmit={handleSubmit}>
        ...
        <button
          ...
          style={{
            padding: "10px 20px",
            background: "#0066ff", // ✅ Blue color theme
            border: "none",
            color: "white",
            fontWeight: "bold",
            borderRadius: "5px",
